...
export default function PlayerControl({ duration, currentTime, playing, togglePlaying, changeCurrentTime }: { duration: number, currentTime: number, playing: boolean, togglePlaying: () => void, changeCurrentTime: (percent: number) => void }) {
